...
public abstract class SimulatedNode {
    ...
    //Initialising Dummy Transaction
    ...
    public void setPayload(String transaction) {
    ...
    private int parseJob(SimulatedJob job, int delay) {
        ...
        //System.out.println("received "+signal.getHash()+", ie.'"+signal.toString()+"' ");
            ...
            case NodeSignal.NEW_TRANSACTION_SIGNAL:
                ...
                if(this.accessChain.hasPermission(signal.getOrigin(), AuthBlockchain.PUBLISH_NODE)) {
                    if(this.transactionWasNotReceivedBefore(signal.getHash(), hash)) {
                        ...
                        HashSet<String> sameBlockTransactions = this.clearForwardTransactionsAt.getOrDefault(blockToClearOn, new HashSet<String>());
    ...
    private void handleNewBlockParsing(Block new_block) {
        ...
        HashSet<String> sameBlockTransactions = this.clearForwardTransactionsAt.getOrDefault(this.internalChain.getHeight(), new HashSet<String>());
